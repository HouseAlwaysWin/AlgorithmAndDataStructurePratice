...
namespace SolutionLib.Tools
{
    public class WatchDog
    {
        ...
        public static void ShowPerformance<T1, T2, T3>(Action<T1, T2, T3> method, T1 t1, T2 t2, T3 t3)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();
            method(t1, t2, t3);
        ...
        public static void ShowPerformance<T1, T2>(Func<T1, T2> method, T1 t1, bool showResult = true)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();
        ...
        public static void ShowPerformance<T1, T2, T3, T4>(Func<T1, T2, T3, T4> method, ref T1 t1, T2 t2, T3 t3, bool showResult = true)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();
            var result = method(t1, t2, t3);
            watch.Stop();
            System.Console.WriteLine($"TimeSpan elapsed time:{watch.Elapsed}");
            if (showResult)
            {
